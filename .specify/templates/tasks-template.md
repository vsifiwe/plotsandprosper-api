...
constitution-defined critical paths and OPTIONAL only for non-critical work
explicitly marked as such in the feature specification.
...
- [ ] TXXX [P] Additional unit tests for non-critical paths (if requested) in tests/unit/
